    ...
    >
      ...
      >
        <div className="flex flex-row gap-3 items-center justify-center">
          ...
          <input type="range" name="range" id="wordCounter"
            step={1} max={9} min={3}
      ...
      >
        ...
        <input type={showPassword ? "text" : "password"}
          onChange={setCustomWord} placeholder="Enter the secret word"
          className="input input-bordered w-full max-w-xs mt-3"
          name="customWord" id="customWord"
        />
        ...
        >
          <i className={`fa ${showPassword ? "fa-eye" : "fa-eye-slash"}`}
            id="passwordIcon" aria-hidden="true"
          ></i>
